...
# The HUD is an example, not a package: it lives in examples/yam/ and is imported by path, the same
# way the deploy scripts import it.
sys.path.insert(0, str(pathlib.Path(__file__).resolve().parents[2] / "examples" / "yam"))
