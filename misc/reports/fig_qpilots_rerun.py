...
# plot_style lives in slurm/ (the publish pipeline owns the house style); this script moved
# to misc/reports/, so reach back for it rather than duplicating the palette.
