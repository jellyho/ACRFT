...
reads the probe's JSON dump, and the ladder/full-data figures are embedded from $CACHE_DIR/plots.
    ...
    uv run --no-sync python misc/reports/make_week_report.py
"""
...
<p class="meta">RoboCasa PrepareCoffee · generated by <code>misc/reports/make_week_report.py</code> · detailed
