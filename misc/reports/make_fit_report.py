...
probe PNGs re-embedded as base64), so regenerating after a new probe lands is just re-running this.
    ...
    uv run --no-sync python misc/reports/make_fit_report.py          # writes $CACHE_DIR/report_fit.html
"""
...
<p class="meta">RLT critic project — RoboCasa PrepareCoffee. Generated by <code>misc/reports/make_fit_report.py</code>;
