...
필요하다. ③ proprio 유무는 무차이. ④ <b>critic 사다리 첫 판정(4시드):</b> RLT2048(FINAL iql) Δ̄=−0.065 → PCA-128 −0.040(McN +25/−33) →
<b>φ-128 +0.035(McN +38/−31, 시드 3/4 양수)</b> — 전부 null이지만 <b>기하 가설이 예측한 단조 배열</b>이
단일변수 사다리에서 그대로 나왔다. φ-128을 n=8로 확장 중(시드 5400–5700 추가), φ×다양화×σ-veto 결합팔(v19)도 제출.</p>
""",
)
...
과대추정된 꼬리 후보를 집는다. <b>v17b 판정(선택 규칙만 교체 — σ-veto 50%):</b> n=4 Δ̄=+0.045, McNemar +34/−25 p=0.298 —
null이나 <b>무-veto의 −0.065(+31/−44)에서 방향이 뒤집혔다.</b> "다양화 + 오차-보수성" 쌍의 예측 시그니처.
n=8로 확장 중, φ-128 critic과의 결합팔(v19)이 현재 최선 가설이다.</p>
